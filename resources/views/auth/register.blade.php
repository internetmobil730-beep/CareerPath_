      ...
      <form method="POST" action="{{ url('/register') }}">
        ...
        <div class="input-group mb-4" style="position: relative;">
          ...
          <button type="button" id="togglePassword" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); background: none; border: none; z-index: 10; cursor: pointer; padding: 0; display: flex; align-items: center;">
            <svg id="eyeIcon1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6c757d" style="width: 22px; height: 22px;">
        ...
        <div class="input-group mb-4" style="position: relative;">
          ...
          <button type="button" id="toggleConfirmPassword" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); background: none; border: none; z-index: 10; cursor: pointer; padding: 0; display: flex; align-items: center;">
            <svg id="eyeIcon2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6c757d" style="width: 22px; height: 22px;">
              <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
              <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            </svg>
          </button>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    togglePasswordButton.addEventListener('click', function () {
      ...
      eyeIcon1.innerHTML = type === 'password' ? eyeOpenPath : eyeSlashPath;
    });

    // 2. التحكم بالحقل الثاني
    ...
    toggleConfirmButton.addEventListener('click', function () {
      ...
      eyeIcon2.innerHTML = type === 'password' ? eyeOpenPath : eyeSlashPath;
    });
  });
</script>
@endsection